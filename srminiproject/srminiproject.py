...
SITES_DATA = {
    "학생": [
        (
            "노션 (Notion)",
            "https://www.notion.so",
            "강의 노트 필기, 시험 일정, 과제 체크리스트 관리 올인원 툴",
        ),
        (
            "미리캔버스 (MiriCanvas)",
            "https://www.miricanvas.com",
            "깔끔한 PPT 발표 자료, 보고서 표지, 카드뉴스 무료 제작",
        ),
        (
            "DeepL 번역기",
            "https://www.deepl.com",
            "과제 및 외국 논문 번역에 특화된 고성능 자연어 AI",
        ),
        (
            "뤼튼 (Wrtn)",
            "https://wrtn.ai",
            "한국어 특화 무료 생성형 AI (과제 아이디어 브레인스토밍, 글 초안 작성)",
        ),
    ],
    "교사": [
        (
            "캔바 (Canva) 교육용",
            "https://www.canva.com",
            "교사와 학생을 위한 고품질 수업 프레젠테이션 및 학습지 제작",
        ),
        (
            "카훗 (Kahoot!)",
            "https://kahoot.com",
            "학생들이 스마트폰으로 참여할 수 있는 실시간 퀴즈 도구",
        ),
        (
            "패들렛 (Padlet)",
            "https://ko.padlet.com",
            "학급 온라인 게시판, 브레인스토밍 및 모둠 과제 취합",
        ),
        (
            "에듀넷 티-클리어",
            "https://www.edunet.net",
            "국가 교육과정 기반의 공식 교수학습 자료 및 교육 연구 포털",
        ),
    ],
    "직장인": [
        (
            "ChatGPT",
            "https://chatgpt.com",
            "기획서 초안 작성, 비즈니스 이메일 검토, 데이터 요약 및 번역 보조",
        ),
        (
            "Smallpdf",
            "https://smallpdf.com",
            "PDF 파일 압축, Word/Excel 변환, 페이지 합치기 및 분할",
        ),
        (
            "트렐로 (Trello)",
            "https://trello.com",
            "칸반 보드 형태로 업무 진행 상태(할 일, 진행 중, 완료) 한눈에 관리",
        ),
        (
            "DeepL",
            "https://www.deepl.com",
            "해외 바이어 이메일 및 외국 비즈니스 문서를 자연스럽게 번역",
        ),
    ],
    "개발자": [
        (
            "깃허브 (GitHub)",
            "https://github.com",
            "전 세계 최대의 소스코드 호스팅 및 버전 관리(Git), 협업 플랫폼",
        ),
        (
            "스택 오버플로우 (Stack Overflow)",
            "https://stackoverflow.com",
            "개발 중 마주치는 에러와 문제 해결 팁을 모아놓은 글로벌 Q&A",
        ),
        (
            "MDN Web Docs",
            "https://developer.mozilla.org",
            "웹 개발(HTML, CSS, JavaScript) 표준을 가장 정확하게 설명하는 문서",
        ),
        (
            "Claude AI",
            "https://claude.ai",
            "코드 리뷰, 리팩토링, 알고리즘 구현 및 에러 디버깅 특화 AI",
        ),
    ],
    "디자이너": [
        (
            "피그마 (Figma)",
            "https://www.figma.com",
            "웹 브라우저에서 협업하는 UI/UX 웹, 앱 디자인 필수 툴",
        ),
        (
            "핀터레스트 (Pinterest)",
            "https://www.pinterest.com",
            "시각적 영감, 디자인 트렌드 및 레퍼런스를 수집하고 정리하는 무드보드",
        ),
        (
            "플래티콘 (Flaticon)",
            "https://www.flaticon.com",
            "수백만 개의 고품질 벡터 아이콘과 스티커 무료 다운로드",
        ),
        (
            "눈누 (Noonnu)",
            "https://noonnu.cc",
            "상업용으로 무료 사용 가능한 예쁜 한글 폰트 모음 및 테스트",
        ),
    ],
    "콘텐츠 제작자": [
        (
            "썸트렌드 (SomeTrend)",
            "https://some.co.kr",
            "소셜 빅데이터 기반 실시간 검색어 트렌드 및 연관 키워드 분석",
        ),
        (
            "브루 (Vrew)",
            "https://vrew.ai",
            "AI 음성인식으로 자동 자막을 생성하고 빠른 컷편집을 돕는 영상 툴",
        ),
        (
            "언스플래시 (Unsplash)",
            "https://unsplash.com",
            "저작권 걱정 없는 상업용 초고화질 무료 이미지 사이트",
        ),
        (
            "미리캔버스 (MiriCanvas)",
            "https://www.miricanvas.com",
            "유튜브 썸네일, 인스타그램 카드뉴스, 블로그 배너 템플릿 제작",
        ),
    ],
    "영상 편집자": [
        (
            ...
            "한국저작권위원회가 제공하는 국가 공인 무료 BGM, 효과음, 폰트 아카이브",
        ),
        (
            "효과음 연구소",
            "https://soundeffect-lab.info",
            "유튜브 영상 편집 시 많이 쓰이는 다양한 무료 효과음(SE) 다운로드",
        ),
        (
            "프리픽 (Freepik)",
            "https://www.freepik.com",
            "영상에 삽입할 모션 그래픽 소스, 비디오 클립, 일러스트 모음",
        ),
        (
            "캡컷 웹 (CapCut)",
            "https://www.capcut.com",
            "웹 브라우저에서 바로 사용 가능한 트렌디한 숏폼/릴스/틱톡 편집 툴",
        ),
    ],
    "기타 사용자(일반 사용자)": [
        (
            "정부24",
            "https://www.gov.kr",
            "주민등록등본 등 각종 민원 서류를 집에서 무료로 즉시 발급받는 포털",
        ),
        (
            "누끼따기 (remove.bg)",
            "https://www.remove.bg/ko",
            "사진을 올리기만 하면 5초 만에 배경을 자동으로 지워주는 AI 사이트",
        ),
        (
            "네이버 지도 (Naver Map)",
            "https://map.naver.com",
            "빠른 길찾기, 대중교통 경로, 거리뷰, 주변 시설 확인 필수 서비스",
        ),
        (
            "ChatGPT",
            "https://chatgpt.com",
            "일상 궁금증 해결, 추천, 편지 및 글 작성을 도와주는 대화형 AI 비서",
        ),
    ],
}
...
def get_ai_shortcut_recommendation(query, os_type):
    ...
    if any(
        ...
        return {
            ...
            "shortcuts": [
                ...
                {
                    "key": k("Ctrl + X", "Cmd + X"),
                    "desc": "💡 한술 더 떠서: 잘라내기 (옮기면서 원본 삭제)",
                },
                {
                    "key": k("Ctrl + Shift + V", "Cmd + Shift + Option + V"),
                    "desc": "💡 한술 더 떠서: 서식 없이 깔끔하게 텍스트만 붙여넣기",
                },
            ],
        }
    ...
    # 2. 창 전환, 화면 전환, 작업창
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Alt + Tab", "Cmd + Tab"),
                    "desc": "실행 중인 작업 창 빠르게 전환",
                },
                {
                    "key": k("Win + D", "F11"),
                    "desc": "💡 한술 더 떠서: 모든 창 최소화하고 바탕화면 즉시 보기",
                },
            ],
        }
    ...
    # 3. 실수로 닫은 탭 / 창 복구
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Ctrl + Shift + T", "Cmd + Shift + T"),
                    "desc": "방금 닫은 인터넷 탭 즉시 다시 열기 (실수 복구)",
                },
                {"key": k("Ctrl + W", "Cmd + W"), "desc": "현재 보고 있는 탭 닫기"},
                {
                    "key": k("Ctrl + T", "Cmd + T"),
                    "desc": "💡 한술 더 떠서: 새로운 인터넷 탭 열기",
                },
            ],
        }
    ...
    # 4. 화면 캡처 / 스크린샷
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Win + Shift + S", "Cmd + Shift + 4"),
                    "desc": "원하는 영역만 마우스 드래그로 부분 캡처",
                },
                {"key": k("PrtScn", "Cmd + Shift + 3"), "desc": "화면 전체 캡처"},
                {
                    "key": k("Alt + PrtScn", "Cmd + Shift + 4 후 Space"),
                    "desc": "💡 한술 더 떠서: 현재 열린 창 하나만 캡처",
                },
            ],
        }
    ...
    # 5. 실행 취소 / 되돌리기
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Ctrl + Z", "Cmd + Z"),
                    "desc": "실행 취소 (방금 한 실수 되돌리기)",
                },
                {
                    "key": k("Ctrl + Y", "Cmd + Shift + Z"),
                    "desc": "💡 한술 더 떠서: 다시 실행 (취소한 작업 다시 복구)",
                },
            ],
        }
    ...
    # 6. 코드 주석
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Ctrl + /", "Cmd + /"),
                    "desc": "코드 한 줄 주석 토글 (지정 / 해제)",
                },
                {
                    "key": k("Ctrl + D", "Cmd + D"),
                    "desc": "같은 단어 연속 다중 선택 (동시 수정)",
                },
                {
                    "key": k("Alt + 위/아래", "Option + 위/아래"),
                    "desc": "💡 한술 더 떠서: 현재 코드 줄 위/아래로 이동",
                },
            ],
        }
    ...
    # 7. 검색 / 찾기 / 바꾸기
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Ctrl + F", "Cmd + F"),
                    "desc": "문서 및 웹페이지 내 키워드 검색",
                },
                {
                    "key": k("Ctrl + H", "Cmd + Option + F"),
                    "desc": "💡 한술 더 떠서: 찾기 및 다른 단어로 일괄 바꾸기",
                },
            ],
        }
    ...
    # 8. 멈춤 / 렉 / 강제 종료 / 화면 잠금
        ...
        return {
            ...
            "shortcuts": [
                {
                    "key": k("Ctrl + Shift + Esc", "Cmd + Option + Esc"),
                    "desc": "작업 관리자 / 강제 종료 창 열기",
                },
                {"key": k("Alt + F4", "Cmd + Q"), "desc": "현재 프로그램 강제 종료"},
                {
                    "key": k("Win + L", "Cmd + Ctrl + Q"),
                    "desc": "💡 한술 더 떠서: 컴퓨터 화면 즉시 잠금 (보안 필수)",
                },
            ],
        }
    else:
        ...
        with st.expander("🔐 로그인 / 회원가입", expanded=False):
            ...
            with tab_l:
                ...
                remember = st.checkbox(
                    "자동 로그인 (로그인 유지)", value=True, key="chk_auto"
                )
...
if menu == "직업 선택하기":
    ...
    if st.session_state.yourjob is None:
        st.write(
            "본인의 직업 또는 역할을 선택하시면 맞춤 단축키와 추천 사이트를 안내해 드립니다."
        )
        job = st.selectbox(
            "당신의 직업은 무엇인가요?",
            [
        ...
        st.write(
            "왼쪽 사이드바 메뉴에서 **'유용한 단축키'** 및 **'유용한 사이트'**를 확인해보세요."
        )
...
# -------------------------------
    ...
    if st.session_state.yourjob is None:
        ...
        search_query = st.text_input(
            "🔍 단축키 실시간 검색",
            placeholder="기능이나 단축키를 검색하세요 (예: 복사, 캡처, Cmd, Shift)",
        )
        ...
        for win_key, mac_key, desc in shortcuts:
            ...
            if search_query.strip():
                if (search_query.lower() not in key_to_display.lower()) and (
                    search_query.lower() not in desc.lower()
                ):
                    continue
...
# -------------------------------
    ...
    if not st.session_state.logged_in:
        st.info(
            "💡 사이드바에서 **로그인**하시면 나만의 단축키 메모가 파일에 안전하게 영구 저장됩니다!"
        )
    else:
        st.success(
            f"**{st.session_state.user_id}**님의 개인 메모 공간입니다. (저장된 메모: {len(st.session_state.my_notes)}개)"
        )
    ...
    with tab_ai:
        ...
        st.write(
            "자연어로 편하게 물어보세요! 연관된 **한술 더 뜬 단축키**까지 함께 추천해 드립니다."
        )
        ...
        if user_ai_input.strip():
            ...
            for i, item in enumerate(result["shortcuts"]):
                ...
                already_registered = any(
                    note["key"] == item["key"] for note in st.session_state.my_notes
                )
    ...
    with tab_manual:
        ...
        with st.form("manual_note_form", clear_on_submit=True):
            ...
            new_desc = col2.text_input(
                "기능 설명", placeholder="예: 닫은 인터넷 창 다시 열기"
            )
            ...
            if submitted:
                if new_key.strip() and new_desc.strip():
                    st.session_state.my_notes.append(
                        {"key": new_key.strip(), "desc": new_desc.strip()}
                    )
                    if st.session_state.logged_in:
                        user_data[st.session_state.user_id][
                            "notes"
    ...
    if not st.session_state.my_notes:
        st.write(
            "아직 등록된 나만의 단축키가 없습니다. 위 탭에서 단축키를 추가해보세요!"
        )
    else:
...
# -------------------------------
    ...
    if st.session_state.yourjob is None:
        ...
        current_job = st.session_state.yourjob
        st.write(
            f"선택된 직업인 **'{current_job}'**의 맞춤 단축키({os_type})와 추천 사이트, 나만의 메모를 텍스트 파일로 다운로드합니다."
        )
